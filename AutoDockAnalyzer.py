...
class GUI(QtWidgets.QWidget):
    ...
    def run_hbonds_dialog(self):
        ...
        if dialog.exec_():
            ...
            calculate_hydrogen_bonds(rec, lig)
    ...
    def cluster_classic(self):
        ...
        Forces strict float numeric types to guarantee international unified dot (.) styling.
        """
    ...
    def load_vina_workflow(self):
        ...
        Ensures explicit primitive floating types to secure standardized visual rendering without missing cells.
        """
