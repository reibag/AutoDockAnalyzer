...
AutoDockAnalyzer is a plugin for PyMOL designed to analyze docking results from AutoDock (.dlg) and AutoDock Vina (.pdbqt). It provides AutoDock-like clustering, thermodynamic data, and visualization tools comparable to AutoDockTools, with extended interactive capabilities.
